            ...
            <div className="appointment-wrapper">											
                <div className="controls">										
                    ...
                    <div className="control-button">
                        <button id="prev-month" type="button" onClick={handlePrevMonth} aria-label="Previous month">
                            <i className="feather icon-chevron-left"></i>
                        </button>
                        <button id="next-month" type="button" onClick={handleNextMonth} aria-label="Next month">
