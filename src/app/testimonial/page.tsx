                                    ...
                                    <div className="testimonial-1">
                                        ...
                                        <div className="testimonial-detail">
                                            <div className="testimonial-text">
                                                ...
                                                <p>Sheba Home Care Services provided exceptional care for my mother. The caregivers were compassionate, professional, and truly cared about her well-being. They helped her maintain her independence while ensuring her safety and comfort at home. I highly recommend their services to anyone looking for quality home care.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    {testiswipeerdata2.map((item, i) => (
                                        <SwiperSlide key={i}>
                                            <div className="content-media">
                                                <Image src={item.image} alt={`${item.name} testimonial`} className="radius-xl shadow-sm object-fit-cover" />
                                                <div className="video-bx3 video-bx">
                                                    <Link onClick={handleShow} href={"#"} scroll={false} className="popup-youtube video-btn" aria-label={`Watch testimonial from ${item.name}`}>
                                                        <i className="fa fa-play" />
                                                    </Link>
                                                </div>
                                            </div>
                            ...
                            <div className="col-lg-6 overflow-hidden wow fadeInUp" data-wow-delay="0.4s" data-wow-duration="0.7s">
                                ...
                                <div className="swiper-btn-center-lr">
                                                    ...
                                                    <div className="testimonial-text">
                                                        <div className="title-head">
                                                            <div className="quote-icon">
                                                                <Image src={IMAGES.quotation} alt="Quote icon" />
                                                            </div>
                                                            <h2 className="title">Outstanding Care</h2>
                                                        </div>
                                                        <p>Sheba Home Care Services provided exceptional care for my mother. The caregivers were compassionate, professional, and truly cared about her well-being. They helped her maintain her independence while ensuring her safety and comfort at home. I highly recommend their services to anyone looking for quality home care.</p>
                                                        <div className="quote">" The caregivers from Sheba Home Care are like family. They treat my loved one with respect, compassion, and professionalism. I couldn't ask for better care. "</div>
                                                    </div>
                                                    <div className="testimonial-detail">
                                                        <div className="dz-media">
                                                            <Image src={item.image} alt={`${item.name} portrait`} />
                                                        </div>
                                    ...
                                    <div className="pagination-align">
                                        <div className="swiper4-button-prev btn-prev" dangerouslySetInnerHTML={{__html : SVGICONS.prev}} role="button" aria-label="Previous testimonials">                                            
                                        </div>
                                        <div className="swiper4-button-next btn-next" dangerouslySetInnerHTML={{__html : SVGICONS.next}} role="button" aria-label="Next testimonials">
                                        </div>
                                    </div>
                                </div>
                            </div>
